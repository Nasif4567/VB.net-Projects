...
Public Class Form_Learning_Materials_Maths
    ...
    Private Sub DownloadFile(NewFileLocation As String)
        Try
            ...
            query = "Select * From LearningMaterials Where LearningMaterial_ID=@Id"
    ...
    Private Sub ButtonLMDLoad_Click(sender As Object, e As EventArgs) Handles ButtonLMDLoad.Click
