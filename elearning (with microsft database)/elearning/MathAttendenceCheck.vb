...
Public Class Amsign
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim command As New OleDbCommand("select * from AttendenceDateMaths where code =@code", con)

            Dim cmd As New OleDbCommand("Insert into MathAttendence([code],[StudentID],[Student Name],[Date]) Values(?,?,?,?)", con)
            ...
            Dim cmd1 As New OleDbCommand("select count(*) from MathAttendence where StudentID=? and code=?", con)
    ...
    Private Sub Amsign_Load(sender As Object, e As EventArgs) Handles MyBase.Load
